...
class _BlogState extends State<Blog> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomMyAccountItemAppBar(title: "BLOG"),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: ListView.separated(
                          shrinkWrap: true,
                          itemCount: controller.searchResultBlogs.length,
                          ...
                          itemBuilder: (context, index) {
                            return Bounceable(
                              onTap: () => Get.toNamed(
                                ...
                                parameters: {
                                  "blogId":
                                      controller.searchResultBlogs[index].id
                                },
                              ),
                              child: Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    controller.searchResultBlogs[index].pics
                                            .isEmpty
                                        ...
                                        : ClipRRect(
                                            ...
                                            child: SizedBox(
                                              ...
                                              child: CachedNetworkImage(
                                                ...
                                                imageUrl:
                                                    "${dotenv.env["BASE_URL"]}${controller.searchResultBlogs[index].pics}",
                                              ),
                                            ),
                                          ),
                                    ...
                                    Expanded(
                                      child: Column(
                                        ...
                                        children: [
                                          Text(
                                            controller.searchResultBlogs[index]
                                                .subject,
