...
class GetStoreTotalVisitorNumberApi {
  final ApiService _apiService = ApiService();
  Future<Response> getTotalVisitor(
      {required GetStoreTotalVisitorNumberRequestModel data}) async {
    try {
      final Response resp = await _apiService.post(
        dotenv.env["TOTAL_VISITOR_NUMBER_URL"].toString(),
